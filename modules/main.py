...
async def root_route_handler(request):
    return web.json_response("https://github.com/TELLYHUBCLOUD")
...
async def account_login(bot: Client, m: Message):
    await m.reply_text(
       Ashu.START_TEXT, reply_markup=InlineKeyboardMarkup(
            [
                    [
                    InlineKeyboardButton("✜ TELLYHUBSUPPOUTS ✜" ,url="https://t.me/TELLYHUBSUPPOUTS") ],
                    [
                    InlineKeyboardButton("🦋 𝐅𝐨𝐥𝐥𝐨𝐰 𝐌𝐞 🦋" ,url="https://t.me/TELLYCLOUD") ]                               
            ]))
